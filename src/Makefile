...
DISTDIR = /home/anonymous/Documents/test/.tmp/project1.0.0
LINK          = g++
...
SOURCES       = main.cpp \
		MatrixCalculator.cpp moc_MatrixCalculator.cpp
OBJECTS       = main.o \
		MatrixCalculator.o \
		moc_MatrixCalculator.o
DIST          = /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		...
		project.pro MatrixCalculator.h main.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents MatrixCalculator.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp MatrixCalculator.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_MatrixCalculator.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MatrixCalculator.cpp
moc_MatrixCalculator.cpp: MatrixCalculator.h \
		moc_predefs.h \
		/usr/lib64/qt6/libexec/moc
	/usr/lib64/qt6/libexec/moc $(DEFINES) --include /home/anonymous/Documents/test/moc_predefs.h -I/usr/lib64/qt6/mkspecs/linux-g++ -I/home/anonymous/Documents/test -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtCore -I/usr/include/c++/14 -I/usr/include/c++/14/x86_64-redhat-linux -I/usr/include/c++/14/backward -I/usr/lib/gcc/x86_64-redhat-linux/14/include -I/usr/local/include -I/usr/include MatrixCalculator.h -o moc_MatrixCalculator.cpp
...
main.o: main.cpp MatrixCalculator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

MatrixCalculator.o: MatrixCalculator.cpp MatrixCalculator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MatrixCalculator.o MatrixCalculator.cpp

moc_MatrixCalculator.o: moc_MatrixCalculator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_MatrixCalculator.o moc_MatrixCalculator.cpp
